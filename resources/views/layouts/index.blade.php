...
<div class="wrapper">
  ...
  <footer class="main-footer" style="text-align: right">
    <strong >Copyright &copy; 2019 <a href="#">Klinik</a>.</strong> All rights
    reserved.
  </footer>
...
<script>
  ...
  function hapusDokter($kode_dokter){
    if(confirm("Are You Sure Want to Delete ?")){
      window.location=("/dokter/hapus/" +$kode_dokter+ "")
    }
  }

  function hapusTerapis($kode_terapis){
    if(confirm("Are You Sure Want to Delete ?")){
      window.location=("/terapis/hapus/" +$kode_terapis+ "")
    }
  }

  function hapusCustomer($kode_customer){
    if(confirm("Are You Sure Want to Delete ?")){
      window.location=("/customer/hapus/" +$kode_customer+ "")
    }
  }

  function hapusPerawatan($kode_perawatan){
    if(confirm("Are You Sure Want to Delete ?")){
      window.location=("/perawatan/hapus/" +$kode_perawatan+ "")
    }
  }

  function hapusBahan($kode_bahan){
    if(confirm("Are You Sure Want to Delete ?")){
      window.location=("/bahan/hapus/" +$kode_bahan+ "")
    }
  }
</script>
</body>
